...
/** Adapter for https://nepotuneapi.vercel.app/api (community fork) */
const BASE = "https://nepotuneapi.vercel.app/api";
const NAME = "nepotune" as const;

export const nepotune: MusicAdapter = {
  name: NAME,
  priority: 70,
